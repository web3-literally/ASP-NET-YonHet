<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<MarketStore_2010.Models.RegisterViewModel>" %>
    ...
    <div class="container">
        ...
        <div class="store-register">
            ...
            <div class="row register-item">
                <label>
                    Owner Email:</label>
                <%=Html.EditorFor(model => model.OwnerMail, new { htmlAttributes = new { @class = "register-input" } })%>
            </div>
            <div class="row register-item">
                <label>
                    Password:</label>
            ...
            <div class="row register-item">
                <label>
                    Store Name:</label>
                <%=Html.EditorFor(model => model.StoreName, new { htmlAttributes = new { @class = "register-input" } })%>
            </div>
            <div class="row register-item">
                <label>
                    Web Link(Store Address):</label>
                <%=Html.EditorFor(model => model.LinkUrl, new { htmlAttributes = new { @class = "register-input" } })%>
            </div>
            <div class="row register-item">
                <label>
            ...
            <div class="row register-item">
                <label>
                    Design Photo URL:</label>
                <input name="ImageFile" type="file" />
            </div>
            <div class="row " style="justify-content: center; margin-top: 30px;">
                <input type="submit" value="submit" style="font-size: 14pt; font-weight: bold; width: 170px; flex-basis: unset;" />
            </div>
        ...
        <div class="store-content container">
            <% for (var i = 0; i < Model.StoreList.Count(); i++)
               { %>
            <div class="store-item">
                <a href="<%: Model.StoreList.ElementAt(i).LinkUrl %>" style="text-decoration: none; color: black!important;">
                    <div class="store-item-inner">
                        <div class="store-item-image" style="background-image: url(<%: Model.StoreList.ElementAt(i).ImageUrl  %>);">
                        </div>
                        <h1 class="text-center">
                            <%: Model.StoreList.ElementAt(i).StoreName%></h1>
                    </div>
                </a>
            </div>
            <% } %>
